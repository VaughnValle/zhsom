...
---
**NOTE:** To uninstall the mod, simply delete the `sounds.resource`, `sharedassets2.assets`, and `resources.assets` files and then verify the integrity of your game files via Steam.
